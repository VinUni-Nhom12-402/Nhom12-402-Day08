...
> - Sprint nào bạn chủ yếu làm? Tôi làm chủ yếu Sprint 1 và 2
> - Cụ thể bạn implement hoặc quyết định điều gì? Tôi implement và Xây dựng grounded prompt 
> - Công việc của bạn kết nối với phần của người khác như thế nào?
     “code thực thi retrieval + generation trong rag_answer.py
      grounded prompt = phần prompt generation dùng context từ chunks và đưa vào LLM để trả lời có citation
      Tôi implement pipeline trong rag_answer.py, gồm retrieve + select + build grounded prompt + call LLM.”
